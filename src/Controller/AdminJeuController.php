...
class AdminJeuController extends AbstractController
{
     ...
     */
    public function edit(Request $request, Jeu $jeu, EntityManagerInterface $entityManager, TranslatorInterface $translate): Response
    {
        $form = $this->createForm(JeuType::class, $jeu);
        $form->handleRequest($request);
     ...
     */
    public function delete(Request $request, Jeu $jeu, EntityManagerInterface $entityManager, TranslatorInterface $translate): Response
    {
