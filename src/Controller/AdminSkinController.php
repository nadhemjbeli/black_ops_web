...
class AdminSkinController extends AbstractController
{
     ...
     */
    public function new(Request $request, EntityManagerInterface $entityManager,SkinRepository $repskin, TranslatorInterface $translate): Response
    {
        $skin = new Skin();
     ...
     */
    public function edit(Request $request, Skin $skin, EntityManagerInterface $entityManager,SkinRepository $repskin, TranslatorInterface $translate): Response
    {
        $form = $this->createForm(SkinType::class, $skin);
        $form->handleRequest($request);
        $file=$skin->getImageSkin();
     ...
     */
    public function delete(Request $request, Skin $skin, EntityManagerInterface $entityManager, TranslatorInterface $translate): Response
    {
